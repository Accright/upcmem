...
public class InKindsEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(InKindsEditActivity.this,OutKindsAddActivity.class);
...
//					delete(item);
    ...
    public void onBackPressed() {
        ...
        intent.putExtra("inke",(Serializable)kindsList);
