...
public class OutFragment extends Fragment {
    ...
    private static final int LOCATION_REQUEST = 1;//请求权限
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        permissionManager = PermissionManager.with(this).addRequestCode(LOCATION_REQUEST)
                .permissions(android.Manifest.permission.ACCESS_FINE_LOCATION,android.Manifest.permission.READ_PHONE_STATE,android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                .setPermissionsListener(new PermissionListener() {
                    ...
                    public void onDenied() {
                        //用户拒绝该权限时调用
                        Toast.makeText(getActivity(), "请求权限失败,打开权限已获取地理位置",Toast.LENGTH_LONG).show();
                    }
